...
import { getTotAccDetails, List_Aging_payable, List_Aging_receivables, totalAccountsReceivableAction } from 'redux/actions/totAcc_actions';
...
function Receivables(props) {
  ...
  // const { TotAccReducer: { payable_receivable, aging_receivable, aging_payable, totalAccountsReceivable } } = useSelector(state => state)
  ...
  //       dispatch(totalAccountsReceivableAction(headerLocationId))
  //     )
  ...
  //   ref2.current();
    ...
    //     dispatch(totalAccountsReceivableAction())
  ...
  // const { data } = props
  // let data1 = totalAccountsReceivable?.totalReceivables ? totalAccountsReceivable?.totalReceivables[0]?.receivablesDueRecord : ''
  ...
  return (
    <Card 
     ...
     >
      ...
      >
        <Grid>
            <Typography variant='h6'> Total Accounts Receivables </Typography>
          </Grid>
      ...
      <Grid align='center' style={{ padding:'35px 10px' }}>
        ...
        <Typography variant='h1' color="text.secondary" gutterBottom >
          ₹ {props?.data[0]?.receivablesDueRecord || '0.00'}
        </Typography>
