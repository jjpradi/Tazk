...
import totalLeadsValue from '../../../assets/dashboardIcons/totalLeadsValue.svg';
import DashboardTile from 'components/DashboardTile';
class TotalLeadsValue extends Component {
        ...
        return (
            ...
            >
                <DashboardTile 
                    ...
                    icon = {totalLeadsValue}
                    value = {this.props.data?.[0]?.totalValue || 0}
                    currencyIcon = {true}
                />
            </div>
        );
...
export default useCommonRef(connect(mapStateToProps, mapDispatchToProps)(TotalLeadsValue))	