...
import { getLeadBySourceAction } from "redux/actions/leadManagement_actions";

class LeadsBySource extends Component {
    ...
    //         await this.props.getLeadBySourceAction(context.headerLocation)
    //     }
    // }
    ...
    //             this.props.getLeadBySourceAction(context.headerLoactionId)
    //         )
    //     }
    ...
    //         this.props.getLeadBySourceAction(context.headerLocationId)
    //     )
    // }
...
const mapStateToProps = (state) => {
    return {
        getLeadSource: state.leadManagementReducers.getLeadSource || [],
    };
};

const mapDispatchToProps = (dispatch) => {
    return {
        getLeadBySourceAction: () => {
            return dispatch(getLeadBySourceAction());
        },
...
export default useCommonRef(connect(mapStateToProps, mapDispatchToProps)(LeadsBySource));
