...
import { getAuditDash, getUnAssignAction } from 'redux/actions/asset_actions';
...
class UnAssignedCard extends Component {
    ...
    //         await  this.props.getUnAssignAction(context.headerLocationId);
    //     }
    ...
    //     if (preProps.getUnAssign !== this.props.getUnAssign) {
    //         const { count, status } = this.props.getUnAssign;
    //         this.setState({
    //             chartData: {
    //                 count: count || 0,
    //                 status: status || 0,
    ...
    //           context.setModalTypeHandler,
    //           context.setLoaderStatusHandler,
    //           this.props.getUnAssignAction(context.headerLocationId)
    //         );
    //       }
...
const mapStateToProps = (state) => {
    return {
        getUnAssign: state.AssetReducers.getUnAssign || [],
...
const mapDispatchToProps = (dispatch) => {
    ...
    return {
        getUnAssignAction: () => {
            return dispatch(getUnAssignAction());
        },
