...
function DocumentType1(props) {
  ...
  useEffect(() => {
    if (empVerificationDetail.length) {
      ...
      setFieldValue('d_number', empVerificationDetail[0]?.d_number);
    } else {
      setFieldValue('verificationType', '');
      setFieldValue('remarks', '');
      setFieldValue('document_name', '');
      setFieldValue('d_number', '');
            ...
            >
              ...
              <Grid
                ...
                <TextField
                  ...
                  error={touched[`d_number`] && Boolean(errors[`d_number`])}
        ...
        <>
          ...
          >
            <Grid
              ...
              {typeLabel} - {values.document_name}
            </Grid>
