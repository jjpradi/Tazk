...
function DrugVerification(props) {
  const {
    index,
    verificationType,
    data,
  ...
  const docSchema = Yup.object().shape({
    report: Yup.string('Type').required('Report is Required!'),
    issued_by : Yup.string('Type').required('Issued By is Required!'),
    issued_date : Yup.string('Type').required('Issued Date is Required!'),
        ...
        <>
          ...
          >
            ...
            <Grid
              ...
              ISSUED DATE - {moment(values.issued_date).format('DD/MM/yyyy')}
            </Grid>
