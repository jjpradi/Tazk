...
function TotalDaysWorkedCountCard(props) {
                ...
                <Box display='flex' height='100%' p='10px' alignItems='center' >
                    ...
                    <Box width='100%' pl='15px'>
                        <Typography style={{ fontSize: "13px", fontWeight: 500 , fontFamily:"Poppins"  }}>
                            {props?.data[0]?.working_days || 0}
                        </Typography>
                        <Box display='flex' mt='4px' alignItems='center'>
                            <Typography color='rgba(0, 0, 0, 0.7)' fontSize='13px' fontFamily="Poppins" fontWeight="500">Total Days&nbsp;Worked</Typography>
                        </Box>
                    </Box>
                    {
                        props.mode === 'edit' ?
...
export default useCommonRef(TotalDaysWorkedCountCard);
