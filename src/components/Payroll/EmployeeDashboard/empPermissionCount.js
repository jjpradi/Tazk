...
import permissionIcon from '../../../assets/dashboardIcons/permissionIcon.png';
...
function EmployeePermissionCountCard(props) {
        ...
        style={{width: '100%'}}>
            <Cards sx={{ height: '100%' }}>
                <Box display='flex' height='100%' p='10px' alignItems='center' >
                    <img src={permissionIcon} height={40} width={40} />
                    <Box width='100%' pl='15px'>
                        <Typography style={{ fontSize: "13px", fontWeight: 500 , fontFamily:"Poppins"  }}>
                            {props?.data[0]?.permissionsTaken || 0}
                        </Typography>
                        <Box display='flex' mt='4px' alignItems='center'>
                            <Typography color='rgba(0, 0, 0, 0.7)' fontSize='13px' fontFamily="Poppins" fontWeight="500">Permission Count</Typography>
                        </Box>
                    </Box>
                    {
                        props.mode === 'edit' ?
...
export default useCommonRef(EmployeePermissionCountCard);
