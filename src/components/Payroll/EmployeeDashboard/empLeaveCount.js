...
import lateCount from '../../../assets/dashboardIcons/leaveCount.png';
...
function EmployeeLeaveCountCards(props) {
        ...
        style={{width: '100%'}}>
            <Cards sx={{ height: '100%' }}>
                <Box display='flex' height='100%' p='10px' alignItems='center' >
                    <img src={lateCount} height={40} width={40} />
                    <Box width='100%' pl='15px'>
                        <Typography style={{ fontSize: "13px", fontWeight: 500 , fontFamily:"Poppins"  }}>
                            {props?.data[0]?.leaveCount || 0}
                        </Typography>
                        <Box display='flex' mt='4px' alignItems='center'>
                            <Typography color='rgba(0, 0, 0, 0.7)' fontSize='13px' fontFamily="Poppins" fontWeight="500">Total Leave</Typography>
                        </Box>
                    </Box>
                    {
                        props.mode === 'edit' ?
...
export default useCommonRef(EmployeeLeaveCountCards);
