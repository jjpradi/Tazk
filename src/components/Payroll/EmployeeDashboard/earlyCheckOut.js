...
function EarlyCheckoutEmp(props) {
        ...
        <Grid size={{ lg: 3 }}>
            ...
            <Grid size={{ lg: 7 }} padding='0px 0px 0px 15px'>
              <Typography style={{ fontSize: "13px", fontWeight: 500 , fontFamily:"Poppins"}}>
                {workDetailsList?.earlyCheckout}
              </Typography>
              
                <Typography color='rgba(0, 0, 0, 0.7)' fontSize='13px' fontFamily="Poppins" fontWeight="500">Early Checkout</Typography>
                </Grid>
                </Grid> */}
            <Box display='flex' height='100%' p='10px' alignItems='center'>
                ...
                <Box width='100%' pl='15px'>
                    <Typography style={{ fontSize: "13px" , fontWeight: 500 , fontFamily:"Poppins" }}>
                        {props?.data[0]?.early_out_count || 0}
                    </Typography>
                    <Box display='flex' mt='4px' alignItems='center'>
                        <Typography color='rgba(0, 0, 0, 0.7)' fontSize='13px' fontFamily="Poppins"  fontWeight="500">Early Checkout
                        </Typography>
                    </Box>
                </Box>
            </Box>
...
export default useCommonRef(EarlyCheckoutEmp);
