...
import LocationWiseCommonDialog from './locationWiseCommonDialog';

function LocationWiseAttendance(props) {
  ...
  //           dispatch(locationWiseAttendanceAction())
  ...
  // console.log('locationWiseAttendance',locationWiseAttendance)
    ...
    <MaterialTable
      ...
      columns={[
        ...
        // },
        {
          ...
          // render: (params) => <PresentPopup params={params} />,
          render: (rowData) => (
            <div
        ...
        },
        {
          ...
          cellStyle: commonCellStyle,
          // render: (params) => <AbsentPopup params={params} />,
          render: (rowData) => (
            <div
        ...
        },
        {
          ...
          cellStyle: commonCellStyle,
          // render: (params) => <LateCheckInPopup params={params} />
          render: (rowData) => (
            <div
        ...
        },
        {
          ...
          cellStyle: commonCellStyle,
          // render: (params) => <EarlyOutPopup params={params} />
          render: (rowData) => (
            <div
...
export default useCommonRef(LocationWiseAttendance);
