...
import {Table, Button, Typography, Card} from '@mui/material';
          ...
          <div>
            ...
            {contactType === 'Customer' ? (
              <MaterialTable
                ...
                data={cust_child.last_bill_child || []}
                title={<Typography variant='h6'>Recent Receivables</Typography>}
              />
            ) : 
...
export default function LastBills(props) {
        ...
        receiptEntry(
          ...
          (response, resdata) => {
            if (response === 200) {
              ...
              //   ),
              // );
              //dispatch(getCustomerErpDetails(getCustomer.customer_id, 'Customer', setLoaderStatusHandler));
