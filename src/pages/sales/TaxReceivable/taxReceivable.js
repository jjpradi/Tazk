...
const TaxReceivable = (props) => {
    ...
    return (
        <>
            <Helmet>
                <meta charSet='utf-8' />
                <title> {titleURL} | TCS Receivable Reports </title>
            </Helmet>
            <DataGridTemp
                columns={columns}
                columnData={columns}
...
>
  ...
  <Typography className='page-title'>TCS Receivable Reports</Typography>
</Breadcrumbs>
                }
