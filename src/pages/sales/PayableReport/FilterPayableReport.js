...
function FilterPayableReport(props) {
  useEffect(() => {
            ...
            <Grid
              ...
              <LocalizationProvider dateAdapter={DateAdapter}>
                <DatePicker
                  ...
                  // error={error}
                  format='DD/MM/YYYY'
                  value={toMomentOrNull(props.from) === null ? props.invoice_from_date : props.invoice_from_date}
                  onChange={(date) =>
                    props.handleChange({
                      target: {value: date, name: 'invoice_from_date'},
                    })
                  }
                  fullWidth={true}
            ...
            <Grid
              ...
              <LocalizationProvider dateAdapter={DateAdapter}>
                <DatePicker
                  ...
                  // inputFormat='DD/MM/yyyy'
                  // error={error}
                  value={props.from === null ? props.invoice_to_date : props.invoice_to_date}
                  onChange={(date) =>
                    props.handleChange({
                      target: {value: date, name: 'invoice_to_date'},
                    })
                  }
                  fullWidth={true}
                  slotProps={{ textField: { fullWidth: true, variant: 'filled' } }}
...
export default FilterPayableReport;
