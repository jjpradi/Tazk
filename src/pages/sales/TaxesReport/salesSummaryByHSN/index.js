...
const SalesSummaryReport = (props) => {
    ...
    const handleExport = async () => {
        ...
        link.setAttribute("download", 'Sales Summary Report By HSN' + ".csv");
    ...
    const reportExport = UserRightsAuthorization(menuAccess[selectedRole], 'reports__taxes__sales_summary_by_hsn', 'can_export')
    return (
        <>
            <Helmet>
                <meta charSet='utf-8' />
                <title> {titleURL} | Sales Summary Report By HSN </title>
            </Helmet>
            <DataGridTemp
                columns={columns}
                columnData={columns}
...
>
  ...
  <Typography className='page-title'>Sales Summary Report By HSN</Typography>
</Breadcrumbs>
                }
