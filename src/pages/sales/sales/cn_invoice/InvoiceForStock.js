...
export default function InvoiceForStock({
  custData,
  invoice,
  soDate,
  sales_items,
  ...
  // console.log("IMEI/Serial Number",sales_items)
  ...
  const groupTaxes = (tax_rate, tax_category) => {
    ...
    for (let data of sales_items) {
      // let arr = [];
      if (data.taxes && data.taxes[0]?.tax_category === tax_category) {
        // for (let d in data) {
  ...
  return (
    <>
      <p style={{ width: '29cm', marginTop: 0 }} className='t_center'>
        {posSale === true
          ? 'Tax Invoice'
          : custType === 'CUSTOMER'
            ? 'Credit Note'
      ...
      <div style={{ width: '29cm', display: 'flex' }}>
        <div
          style={{
          ...
          <Grid container>
            <Grid style={{ marginBottom: 5 }} size={7}>
              {custType === 'CUSTOMER' ? (
                // {/* {posSale != true ?  */}
                (<>
                  <div style={{ paddingLeft: 3, minHeight: 120 }}>
                    <p className='p'>{companyName}</p>
                  ...
                  <div style={{ paddingLeft: 3, minHeight: 120 }}>
                    {custData ? (
                      <>
                        ...
                        <p className='p'>{`${custData.company_name || custData.first_name
                          }`}</p>
                  ...
                  <>
                    <Grid style={{ borderRight: '1px solid black' }} size={6}>
                      <div className='invoice'>
                        ...
                        <p
                          className='p'
                          style={{ visibility: invoice ? 'visible' : 'hidden' }}
                        >
                          {invoice || '-'}
                        </p>
                      </div>
                  ...
                  <>
                    <Grid style={{ borderRight: '1px solid black' }} size={6}>
                      <div className='invoice'>
                        ...
                        <p
                          className='p'
                          style={{ visibility: debitSequence ? 'visible' : 'hidden' }}
                        >
                          {debitSequence || '-'}
                        </p>
                      </div>
            ...
            <Grid className='b_top' size={7}>
              <div style={{ display: 'flex', height: 37 }} className='b_bottom'>
                ...
                <div className='b_right'>
                  <p style={{ width: 86, textAlign: 'center' }} className='p'>
                    {custType === 'CUSTOMER'
                      ? 'Invoice Date'
                      : 'Date'}
                ...
                <div className='b_right'>
                  <p style={{ margin: '0 auto', width: 153, textAlign: 'center' }} className='p'>
                    {custType === 'CUSTOMER'
                      ? 'Invoice Number'
                      : 'Debit Note Number'}
                  </p>
              ...
              <Grid container>
                    ...
                    <Grid style={{ display: 'flex' }} key={d} size={7}>
                      <Grid container>
                        ...
                        <Grid
                          ...
                          <div style={{ marginTop: 8 }}>
                            <p className='p'>{d.invoice_date}</p>
                          </div>
                        </Grid>
                        <Grid
                          className='b_right'
                          ...
                          <div style={{ marginTop: 8 }}>
                            <p className='p'>{d.invoice_number}</p>
                          </div>
                        </Grid>
                        <Grid size="grow">
                    ...
                    <Grid style={{ display: 'flex' }} size={5}>
                      <Grid container>
                        ...
                        <Grid className='b_right' size="grow">
                          ...
                          >
                            <p className='p'>{manualnote === undefined ?`${d.quantity} NOS` : `${d.return_quantity} NOS`}</p>
                ...
                <Grid style={{ display: 'flex' }} size={7}>
                      <Grid container>
                        ...
                        <div style={{ marginTop: 8 }}>
                            <p className='p'>{manualnote?.invoice_date}</p>
                          </div>
                          </Grid>
                        <Grid
                          className='b_right'
                        ...
                        <Grid size="grow">
                          <div style={{ display: 'flex' }}>
                            <div style={{ marginTop: 8 }} className='mlr'>
                              <p className='p'>{manualnote?.name}</p>
                              {''}
                              {/* <p className='p'>Batch : 3355590463199447</p> */}
                            </div>
                          </div>
            ...
            <Grid size={7}>
              <div className='b_top b_bottom' style={{ display: 'flex' }}>
                ...
                <p className='b_right p' style={{ width: 87, height: 24 }}></p>
                <p className='b_right p' style={{ width: 154, height: 24 }}></p>
                <p style={{ marginLeft: 'auto' }} className='mlr p'>
                  Total
                </p>
              </div>
            </Grid>
            <Grid size={5}>
              ...
              >
                ...
                <Grid className=' b_right' size="grow">
                  <p className='mlr p'>{`${totalQuantity()} NOS`}</p>
                </Grid>
                <Grid className='b_right ' size="grow"></Grid>
                <Grid className='b_right' size={1}></Grid>
                <Grid size={3}>
                    ...
                    <Grid size={9}>
                      <Grid container>
                        ...
                        <Grid style={{ width: 115 }} className='b_right t_center'>
                          <Grid container>
                            <Grid className='b_right' size={5}>
                              <p className='b_bottom t_right plr p'>{`${getTcs(d)
                                }%`}</p>
                            </Grid>
                            <Grid size={7}>
                              <p className='b_bottom t_right plr p'>
            ...
            <Grid size={12}>
              <Grid container className='b_bottom'>
                ...
                <Grid size={9}>
                  <Grid container>
                    <Grid className='b_right' size="grow">
                      <p className='t_right plr p'>{totalCost()?.toFixed(2)}</p>
                    </Grid>
                    <Grid style={{ width: 115 }} className='b_right t_center'>
                      <Grid container className=''>
                        <Grid className='b_right' size={5}>
                    ...
                    <Grid size="grow">
                      <p className='t_right plr p'>{(taxes()+ tcstaxes()).toFixed(2)}</p>
                    </Grid>
                  </Grid>
                </Grid>
              </Grid>
