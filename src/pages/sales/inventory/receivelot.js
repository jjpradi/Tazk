...
export default function AlertDialog(props) {
  ...
  const handleSubmit = () => {
    ...
    if (isvalid) {
      ...
      const full = [...props.edit_data.childresult];
      const index = props.row_id.id;
      full[index] = last;
      props.receiverLotUpdate({...props.edit_data, childresult: full},()=>{
        props.handleSubmit({...props.edit_data, childresult: full})
      });
      // props.setedit_data({...props.edit_data, childresult: full});
      // }else{
  ...
  // const checkQuantity = (avail_quan, value)=>{
  //   let quan = true
  //   if(value > avail_quan){
  //     quan = false
  //   }
      ...
      >
        ...
        <DialogContent style={{overflowX: 'hidden'}}>
          <div style={{width: '450px'}}>
            {/* <DialogContentText id="receivelot-dialog-description"> */}
