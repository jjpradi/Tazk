    ...
    <>
      ...
      <Card sx={{ p: 2, width: '100%', height: 'calc(100vh - 90px)', display: 'flex', flexDirection: 'column' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, pb: 1.5, minHeight: 48, flexWrap: 'wrap' }}>
          ...
          <KpiCard label='Value' value={`\u20B9${Number(kpis.totalValue || 0).toLocaleString('en-IN', { maximumFractionDigits: 0 })}`} color='#0A8FDC' />
          <KpiCard label='Pending' value={kpis.pendingCount || 0} color='#E65100' />
          <KpiCard label='Cleared' value={kpis.clearedCount || 0} color='#11C15B' />
          <KpiCard label='Bounced' value={kpis.bouncedCount || 0} color='#d32f2f' />
