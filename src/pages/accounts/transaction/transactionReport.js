...
const TransactionReport = (props) => {
    ...
    const reportExport = UserRightsAuthorization(menuAccess[selectedRole], 'reports__transactions__all_transactions', 'can_export')
...
>
  ...
  {/* <Box style={{ display: 'flex' }}> */}
   ...
   <Typography className='page-title'>Transactions Reports</Typography>
    {/* &nbsp;/&nbsp;Sales Report */}
    {/* </Box> */}
</Breadcrumbs>
                }
