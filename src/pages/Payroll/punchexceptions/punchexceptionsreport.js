...
import { getEmpbasecompanyAction, getSearchpunchReportAction, lateAndEarlyReportAction, punchexceptionAction, setSearchPunchReportAction } from 'redux/actions/attendance_actions';
...
const PunchExceptionReport = (props) => {
    ...
    const { attendanceReducer: { punchexceptionreport }, 
    ...
    const columns = [
        ...
        { field: 'employee_code', headerName: 'Emp Code', flex: 1, },
        {
            field: 'full_name',
            headerName: 'Name',
            flex: 1,
        ...
        {
            field: 'punch_count', headerName: 'Punch Count', flex: 1,
            // renderCell: (params) => (
            //     <div style={commonCellStyle}>
        ...
        { field: 'expected_punch', headerName: 'Punch Limit', flex: 1},
        
     
        { field: 'actual_login_time', headerName: 'Actual Check IN', flex: 1,
             renderCell: (params) => (
                <div style={commonCellStyle}>
         ...
         { field: 'actual_logout_time', headerName: 'Actual Check OUT', flex: 1,
                renderCell: (params) => (
                <div style={commonCellStyle}>
    ...
    const originalData = punchexceptionreport?.data;
    ...
    const reportExport = UserRightsAuthorization(menuAccess[selectedRole], 'reports__attendance__punch_exceptions', 'can_export')
    const handleExport = async () => {
        ...
        link.setAttribute("download", 'Punch Exceptions' + ".csv");
    ...
    return (
        <>
            <Helmet>
                <meta charSet='utf-8' />
                <title> {titleURL} | Punch Exceptions</title>
            </Helmet>
            <Card
                sx={{
                    width: '100%',
                ...
                <Box sx={{ flex: 1, minHeight: 0, overflow: 'hidden' }}>
                    {isApiFinished ? (
                        <DataGrid
                            ...
                            rowCount={punchexceptionreport?.numRows || 0}
...
export default PunchExceptionReport;