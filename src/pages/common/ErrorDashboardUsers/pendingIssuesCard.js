...
import PendingIcon from '../../../assets/dashboardIcons/PendingIssue.png';
...
function EmployeeCard(props) {
    ...
    const {
        PayrolldashboardReducers: { employeeCount },ErrorDashboardReducer: {error_dashboard_list, error_dashboard_list_count, error_dashboard_list_pendingCount}
      ...
      console.log(error_dashboard_list, "error_dashboard_list")

      function countPendings() {
        const data21 = error_dashboard_list.filter((d) => d.current_status !== "DONE");
        return data21.length;
      }
                ...
                <Grid container>
                    <Grid
                        ...
                        <Grid container display='flex' >
                            <Grid paddingLeft={3}>
                                <img src={PendingIcon} height={50} width={50} />
                            </Grid>
                            <Grid padding='15px 0px 0px 15px'>
                                <Typography style={{ fontSize: "18px", fontWeight: 500 }}>
                                    {error_dashboard_list_pendingCount}
                                </Typography>
